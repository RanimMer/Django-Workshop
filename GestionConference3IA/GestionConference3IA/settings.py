"""
Django settings for GestionConference3IA project.
...
SECRET_KEY = 'django-insecure-s8n%%!)xhs8j-hs!fyh^l!(ff#je5yav_pfui@--o5@3j@s1f#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / "GestionConference3IA/Templates" ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
